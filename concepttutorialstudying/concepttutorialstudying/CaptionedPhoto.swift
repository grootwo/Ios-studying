...
struct Caption: View {
    ...
    var body: some View {
        Text(text)
            .padding()
            .background(Color("TextContrast").opacity(0.8), in: RoundedRectangle(cornerRadius: 15, style: /*@START_MENU_TOKEN@*/.continuous/*@END_MENU_TOKEN@*/))
            .padding()
    }
}

struct CaptionedPhoto_Previews: PreviewProvider {
    static let imageName1 = "Pink_Peony"
    static let imageCaption1 = "This is a cute shark."
    static let imageName2 = "Yellow_Daisy"
